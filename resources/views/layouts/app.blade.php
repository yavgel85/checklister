    ...
    <header class="c-header c-header-light c-header-fixed c-header-with-subheader">
        <button class="c-header-toggler c-class-toggler d-lg-none mfe-auto" type="button" data-target="#sidebar"
            ...
            <svg class="c-icon c-icon-lg">
                <use xlink:href="/vendors/@coreui/icons/svg/free.svg#cil-men#cil-menu"></use>
            </svg>
        </button>
        <ul class="c-header-nav ml-auto mr-4">
            <li class="c-header-nav-item d-md-down-none mx-2"><a class="c-header-nav-link" href="#">
                    <svg class="c-icon">
                        <use xlink:href="/vendors/@coreui/icons/svg/free.svg#cil-men#cil-bell"></use>
                    </svg>
                </a></li>
            <li class="c-header-nav-item d-md-down-none mx-2"><a class="c-header-nav-link" href="#">
                    <svg class="c-icon">
                        <use xlink:href="/vendors/@coreui/icons/svg/free.svg#cil-men#cil-list-rich"></use>
                    </svg>
                </a></li>
            <li class="c-header-nav-item d-md-down-none mx-2"><a class="c-header-nav-link" href="#">
                    <svg class="c-icon">
                        <use xlink:href="/vendors/@coreui/icons/svg/free.svg#cil-men#cil-envelope-open"></use>
                    </svg>
                </a></li>
                ...
                <div class="dropdown-menu dropdown-menu-right pt-0">
                    ...
                    <a class="dropdown-item" href="#">
                        ...
                        Messages<span class="badge badge-success ml-auto">42</span></a><a class="dropdown-item"
                                                                                          href="#">
                        <svg class="c-icon mr-2">
                            <use xlink:href="/vendors/@coreui/icons/svg/free.svg#cil-men#cil-task"></use>
                        </svg>
                        Tasks<span class="badge badge-danger ml-auto">42</span></a><a class="dropdown-item" href="#">
                        <svg class="c-icon mr-2">
                            <use xlink:href="/vendors/@coreui/icons/svg/free.svg#cil-men#cil-comment-square"></use>
                        </svg>
                        Comments<span class="badge badge-warning ml-auto">42</span></a>
                    <div class="dropdown-header bg-light py-2"><strong>Settings</strong></div>
                    <a class="dropdown-item" href="#">
                        <svg class="c-icon mr-2">
                            <use xlink:href="/vendors/@coreui/icons/svg/free.svg#cil-men#cil-user"></use>
                        </svg>
                        Profile</a><a class="dropdown-item" href="#">
                        <svg class="c-icon mr-2">
                            <use xlink:href="/vendors/@coreui/icons/svg/free.svg#cil-men#cil-settings"></use>
                        </svg>
                        Settings</a><a class="dropdown-item" href="#">
                        <svg class="c-icon mr-2">
                            <use xlink:href="/vendors/@coreui/icons/svg/free.svg#cil-men#cil-credit-card"></use>
                        </svg>
                        Payments<span class="badge badge-secondary ml-auto">42</span></a><a class="dropdown-item"
                                                                                            href="#">
                        <svg class="c-icon mr-2">
                            <use xlink:href="/vendors/@coreui/icons/svg/free.svg#cil-men#cil-file"></use>
                        </svg>
                        Projects<span class="badge badge-primary ml-auto">42</span></a>
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item" href="#">
                        <svg class="c-icon mr-2">
                            <use xlink:href="/vendors/@coreui/icons/svg/free.svg#cil-men#cil-lock-locked"></use>
                        </svg>
                        Lock Account</a><a class="dropdown-item" href="#">
                        <svg class="c-icon mr-2">
                            <use xlink:href="/vendors/@coreui/icons/svg/free.svg#cil-men#cil-account-logout"></use>
                        </svg>
                        Logout</a>
                </div>
            </li>
